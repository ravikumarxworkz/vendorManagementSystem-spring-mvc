		...
		<form action="#" method="post">
			...
			<div class="form-group">
				<label for="email" class="form-label">EmailID:</label> <input
					...
					required="required"> <span id="emailError" class="validError"
					></span> <span id="emailSuccess"
						...
						<div class="col">
							<div class="input-container">
								<input type="text" class="form-control" id="ownerName"
									name="ownerName" onchange="onName()" required> <label
						...
						<div class="col">
							<div class="input-container">
								<input type="text" class="form-control" id="vendorName"
									...
									for="vendorName">Vendor Name</label> <span id="errorVendorName" class="validError"></span>
							</div>
						</div>
						<div class="col">
							<div class="input-container">
								<input type="text" class="form-control" id="gstNumber"
									...
									for="gstNumber">GST Number</label> <span id="errorGSTNumber" class="validError"></span>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col">
							<div class="input-container">
								<input type="text" class="form-control" id="website"
									...
									for="website">WebSite</label> <span  id="errorWebsite" class="validError"></span>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col">
							<div class="input-container">
								<input type="text" class="form-control" id="pincode"
									name="pincode" required onchange="validatePincode()" /> <label
